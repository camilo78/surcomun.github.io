...
## 3. Lo que sí ocurre técnicamente al visitar el Sitio
 
Por la propia naturaleza de cómo funciona la web, hay información técnica mínima que cualquier servidor recibe cuando alguien visita una página. Por transparencia, te lo contamos:
...
- **Analítica anónima con GoatCounter.** Utilizamos [GoatCounter](https://www.goatcounter.com/) para contar visitas al sitio. GoatCounter **no usa cookies**, no recopila datos personales, no rastrea usuarios entre sitios y no construye perfiles de comportamiento. Registra únicamente datos agregados: la URL visitada, el país de origen (derivado de la IP, que se descarta de inmediato y no se almacena), el navegador y el sistema operativo. Estos datos son públicos y podés consultarlos en [estadisticas.surcomun.com](https://estadisticas.surcomun.com/). La política de privacidad del servicio está disponible en [goatcounter.com/help/privacy](https://www.goatcounter.com/help/privacy).
- **Recursos servidos desde nuestro propio dominio.** Las fuentes tipográficas, las hojas de estilo, los scripts y las imágenes se sirven desde `surcomun.com`. No usamos Google Fonts ni ninguna otra red de distribución externa: cargar una fuente desde un servidor ajeno le entregaría tu IP a esa empresa en cada visita, y nos pareció una contradicción con el resto de esta política. Las fuentes están alojadas por nosotros y no generan ninguna conexión a terceros.
- **Alojamiento.** El sitio es estático y se publica mediante GitHub Pages, propiedad de Microsoft. Como cualquier servidor web, recibe la solicitud de tu navegador y con ella tu dirección IP. No tenemos acceso a esos registros ni los usamos.
- **Vídeos de YouTube.** Algunos artículos incluyen vídeos alojados en YouTube, pero **no se cargan solos**. Lo que ves al abrir la página es una imagen fija servida desde nuestro dominio: hasta ahí, YouTube no recibe absolutamente nada. Sólo si hacés clic sobre ella se carga el reproductor, y en ese momento YouTube recibe tu IP y puede leer o escribir sus propias cookies. Usamos el dominio `youtube-nocookie.com`, que limita ese seguimiento pero no lo elimina. La decisión es tuya y sabés de antemano qué implica.
- **Donaciones.** El botón para apoyar la revista es un enlace corriente a Ko-fi. No hay ningún widget ni script suyo ejecutándose en el sitio: si no hacés clic, Ko-fi nunca se entera de que estuviste acá.

**Navegar por surcomun.com no genera ninguna conexión a servidores de terceros.** Ni fuentes, ni íconos, ni scripts, ni imágenes, ni gráficos incrustados: todo se sirve desde nuestro propio dominio. Las únicas conexiones externas posibles son las que iniciás vos al pulsar un vídeo o un enlace. Podés comprobarlo abriendo la pestaña de red en las herramientas de desarrollo de tu navegador.
...
## 4. Cookies: qué son y cuáles usamos
 
Una cookie es un pequeño archivo de texto que un sitio guarda en tu navegador para recordar información entre visitas. Hay cookies que sirven para vigilar y otras que sirven para que las cosas funcionen. Sur Común sólo usa las segundas.
...
Si nos escribís a cualquiera de las direcciones publicadas en el Sitio (`redaccion@`, `colaboraciones@`, `cartas@`, `correcciones@`, `legal@`, `privacidad@`), recibimos tu mensaje con la información que vos hayas decidido incluir: dirección de remitente, nombre, contenido del mensaje, archivos adjuntos.
 
Usamos esa información únicamente para responderte y, cuando aplica, para procesar tu solicitud (publicar tu carta, evaluar tu colaboración, corregir un error). Conservamos los correos durante el tiempo razonable para dar seguimiento al asunto y, una vez resuelto, los archivamos o eliminamos según corresponda. No los compartimos con terceros ni los usamos para enviarte comunicaciones que no hayas solicitado.
 
### 5.2 Aportes económicos voluntarios
 
Si decidís contribuir económicamente con la revista a través de las plataformas enumeradas en la sección **Apóyanos**, esos pagos los procesa la plataforma de pago (PayPal, Stripe, Patreon, Buy Me a Coffee, transferencia bancaria u otra). **Sur Común no recibe los datos de tu tarjeta, cuenta bancaria ni identidad fiscal.** Sólo vemos lo que la plataforma nos comparte: típicamente, un nombre o alias y un monto. La política de privacidad aplicable a esos datos es la de la plataforma de pago, no la nuestra.
...
## 6. Fuentes confidenciales
 
Cuando alguien nos hace llegar información sensible —documentos, testimonios, datos de interés público— por canales seguros (Signal, PGP, correo cifrado), aplicamos un compromiso reforzado de protección:
 
- No conservamos metadatos más tiempo del estrictamente necesario.
- No revelamos la identidad de la fuente bajo ninguna circunstancia.
- No cedemos la información ni los datos asociados a terceros, gobiernos ni autoridades, salvo que medie una orden judicial firme dictada por un tribunal hondureño competente, en cuyo caso —y sólo en ese caso— actuaríamos conforme a derecho, agotando previamente los recursos legales disponibles.
Si tenés información para hacernos llegar y querés orientación sobre cómo hacerlo de forma segura, escribinos primero a [seguridad@surcomun.com](mailto:seguridad@surcomun.com) sin enviar el material todavía.
 
---
 
## 7. Marco legal aplicable
 
Sur Común opera desde Honduras y se rige por la legislación hondureña en materia de privacidad e intimidad. A diferencia de la Unión Europea, **Honduras no cuenta a la fecha con una ley específica de protección de datos personales aprobada y vigente**. Las garantías aplicables se desprenden, por tanto, de las siguientes normas:
 
- **Constitución de la República de Honduras.**
  - **Artículo 76:** garantiza la protección al honor, a la intimidad personal y familiar y a la propia imagen.
  - **Artículo 100:** establece la inviolabilidad y el secreto de las comunicaciones.
  - **Artículo 182:** consagra, junto con el Hábeas Corpus, la **garantía constitucional del Hábeas Data**, reformada por Decreto Legislativo No. 237-2012 y ratificada por Decreto No. 10-2013. Reconoce a toda persona el derecho de acceder a la información sobre sí misma o sus bienes contenida en bases de datos, registros públicos o privados, de forma expedita y no onerosa, así como a actualizarla, rectificarla o enmendarla. La Sala de lo Constitucional de la Corte Suprema de Justicia es el órgano competente para conocer de esta acción.
- **Ley sobre Justicia Constitucional (Decreto No. 244-2003)**, que desarrolla el procedimiento para ejercer la acción de Hábeas Data ante los tribunales.
- **Ley de Transparencia y Acceso a la Información Pública (Decreto No. 170-2006)**, que en sus artículos 23 y siguientes desarrolla aspectos del Hábeas Data y del tratamiento de datos personales confidenciales.
- **Tratados internacionales** suscritos por Honduras: la Declaración Universal de Derechos Humanos, la Convención Americana sobre Derechos Humanos (Pacto de San José) y el Pacto Internacional de Derechos Civiles y Políticos.
Esta política no se basa en el Reglamento General de Protección de Datos (RGPD) europeo, que **no es aplicable a Sur Común** por razón de territorio. No obstante, hemos adoptado voluntariamente buenas prácticas inspiradas en estándares internacionales por una sencilla razón: nos parece lo correcto.
 
---
 
## 8. Tus derechos
 
Aunque, como explicamos, prácticamente no recopilamos datos personales tuyos, querés saber qué derechos tenés respecto de la información que sí podríamos tener (un correo que nos enviaste, por ejemplo). Por compromiso editorial propio, podés:
 
- **Acceder** a la información que tengamos sobre vos, si la hubiera.
...
Aplicamos medidas técnicas razonables para proteger la integridad del sitio y la información que recibimos por correo: conexiones cifradas (HTTPS), almacenamiento de correspondencia con contraseñas fuertes y autenticación de dos factores, cifrado en reposo cuando es posible, y eliminación periódica de datos que ya no son necesarios.
 
Ningún sistema conectado a Internet es invulnerable, pero el riesgo se reduce significativamente cuando, en primer lugar, **se decide no recolectar lo que no se necesita**. Esa es nuestra principal medida de seguridad.
...
Para cualquier consulta, ejercicio de derechos, denuncia o duda sobre esta Política de privacidad:
 
[privacidad@surcomun.com](mailto:privacidad@surcomun.com)