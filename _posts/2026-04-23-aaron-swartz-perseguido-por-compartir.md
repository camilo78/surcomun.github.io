...
- [*The Internet's Own Boy* — en inglés (Internet Archive)](https://archive.org/details/TheInternetsOwnBoyTheStoryOfAaronSwartz)
- [*The Internet's Own Boy* — subtitulado en español (YouTube)](https://www.youtube.com/results?search_query=the+internets+own+boy+subtitulado+espa%C3%B1ol)

## Lectura recomendada

- [Manifiesto de la Guerrilla por el Acceso Abierto](https://es.wikisource.org/wiki/Manifiesto_de_la_Guerrilla_por_el_Libre_Acceso)
