---
layout: post
title: "La guerra que perdimos sin pelearla"
...
<figure class="post-cover">
  <img src="{{ page.cover_image }}" alt="{{ page.title | escape }}" class="post-cover-image" width="1200" height="675" />
...
Y, sobre todo, hay que dejar de analizar y empezar a contar. La izquierda ha desarrollado, en el último medio siglo, una capacidad analítica notable: sabemos cuál es la trayectoria exacta de la flecha, podemos dibujar el arco, calculamos sin error la influencia del viento. Pero nos faltan arqueros. Nos sobran físicos del proyectil y nos falta gente que lance flechas. La metáfora describe bien el problema: la izquierda actual analiza muy bien, pero produce muy poco. Le sobran cabezas para entender el mundo y le faltan manos para contarlo. Le faltan novelas, canciones, series, memes, celebraciones populares —todo eso que en el día a día le va enseñando a la gente qué es normal y qué no.
...
Hay un riesgo obvio en este tipo de textos: convertirlos en un desfile de autores aplicado sin matices a una realidad como la nuestra, que tiene su propia historia y sus propias contradicciones. Para evitar ese riesgo, conviene cerrar con tres observaciones específicas para nuestra región.
 
**Primera.** La invención de la clase media también se hizo acá, pero con materiales propios. La aspiración de ser "clase media" en Centroamérica no se monta sobre una clase obrera fordista derrotada, como en Inglaterra. Se monta sobre una mayoría empobrecida que, ante la ausencia de un Estado que garantice derechos básicos, aprendió a leer su propia supervivencia como mérito personal y la pobreza del vecino como falta de esfuerzo. *Si yo logré ponerle techo a mi familia, fue porque me esforcé. Si el otro no lo logra, será porque no quiso.* Esa lectura le sirve al orden tal como está, y se repite todos los días desde la televisión, los púlpitos de las megaiglesias y, cada vez más, las redes sociales.
 
**Segunda.** La idea del "emprendedor de sí mismo" que describía Wendy Brown se encarnó en Honduras como una pedagogía oficial. Cada joven sin trabajo recibe el mismo consejo: monte su propio negocio. Cada migrante: aproveche bien las remesas, inviértalas, no las "queme". Cada trabajadora informal: profesionalícese, capacítese, certifíquese. La operación es siempre la misma: tomar un problema político —la falta de empleo digno— y devolvérselo a cada persona como un proyecto individual. Si funciona, es mérito propio. Si fracasa —y casi siempre fracasa— es culpa propia. El gobierno no falló: usted no se esforzó lo suficiente.
 
**Tercera.** En este país, defender la cultura no es un lujo. Es —junto con la defensa de la tierra, del agua y de la vida de quienes las defienden— uno de los pocos terrenos donde todavía puede recomponerse, con paciencia, una identidad colectiva capaz de nombrar al adversario. Asaltar la cultura, parafraseando una formulación clásica, no es tomarla por la fuerza: es liberarla de la lógica que la convierte en mercancía decorativa, devolverle el carácter de espacio de disputa y, donde haga falta, construir un aparato cultural propio sin pedir permiso.
...
*Este texto se publica bajo licencia [Creative Commons Reconocimiento 4.0 Internacional (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/deed.es).*