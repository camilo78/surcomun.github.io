...
Sur Común se escribe con puertas abiertas. Si tenés algo que proponer, corregir, debatir o compartir, hay distintas maneras de llegar a nosotros: elegí la que mejor se ajuste a lo que necesitás.
...
- Texto inédito o, si fue publicado antes, con permiso explícito para republicar.
- Extensión orientativa: entre 800 y 2.500 palabras, según la sección.
- Referencias verificables cuando el texto haga afirmaciones factuales.
- Perspectiva propia: nos interesa más una mirada clara que un tema novedoso.
No todas las propuestas pueden publicarse, pero todas reciben respuesta.
 
---
 
## Documentos y fuentes confidenciales
 
Si tenés información de interés público —documentos, datos, testimonios— y preferís hacerla llegar de forma segura, recomendamos usar herramientas de mensajería cifrada como [Signal](https://signal.org) o correo con cifrado PGP.
...
- Título del artículo o enlace directo.
- Pasaje específico donde está el error.
- Corrección sugerida y, si es posible, una fuente que la respalde.
