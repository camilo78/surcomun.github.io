...
- **Analítica anónima con GoatCounter.** Utilizamos [GoatCounter](https://www.goatcounter.com/) para contar visitas al sitio. GoatCounter **no usa cookies**, no recopila datos personales, no rastrea usuarios entre sitios y no construye perfiles de comportamiento. Registra únicamente datos agregados: la URL visitada, el país de origen (derivado de la IP, que se descarta de inmediato y no se almacena), el navegador y el sistema operativo. Estos datos son públicos y podés consultarlos en [surcomun.goatcounter.com](https://estadisticas.surcomun.com/). La política de privacidad del servicio está disponible en [goatcounter.com/help/privacy](https://www.goatcounter.com/help/privacy).
